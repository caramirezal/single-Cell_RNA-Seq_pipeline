...
## bam indexing and sorting
echo '... bam file indexing and sorting ...'
samtools sort -o data/bam/sorted.bam data/bam/alignment.bam
echo 'bam file indexing and sorting finished'

## quantification
echo 'couting reads using featureCounts ...'
featureCounts -Q 30 -p -a data/gtf_reference/Mus_musculus.GRCm38.94.gtf -o data/quant/rna_quant.tsv data/bam/sorted.bam
